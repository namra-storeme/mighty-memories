        ...
        <form action={action} className="space-y-6">
          <div>
            ...
            <input
              ...
              maxLength={6}
              required
              className="w-full px-4 py-4 text-center text-2xl tracking-widest font-mono border border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 outline-none bg-gray-50 focus:bg-white transition"
            />
          </div>
