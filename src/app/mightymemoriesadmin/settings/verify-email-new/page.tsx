...
import { verifyNewEmailOTP } from "../../actions";

export default function Page() {
  const [state, action, isPending] = useActionState(async (prevState: any, formData: FormData) => {
    return await verifyNewEmailOTP(formData);
  }, null);
    ...
    <div className="max-w-md mx-auto mt-12">
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-gray-900 mb-2">Verify New Email</h1>
          <p className="text-gray-500 text-sm">We sent a 6-digit OTP to your NEW email address. Enter it below to finalize the change.</p>
        </div>
